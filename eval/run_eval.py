...
def main() -> int:
    ...
    parser.add_argument("--review-file", type=Path, default=ROOT / "human-review.json")
    ...
    review = json.loads(args.review_file.read_text(encoding="utf-8")) if args.review_file.is_file() else {}
    ...
    summary = {
        ...
        "human_review_complete": all(
            item["human_review"].get("grounded") is not None
            for item in results
